...
* Reporting when probabilities are equal to 1 or 0 no longer fails (#1)
* \code{Hmisc::wtd.mean} is now used to summarise
* Index and dictionary inputs are forced to data.frame (#2)
* Clarification that the p-values for difference in mean are stochastically derived (#3)
